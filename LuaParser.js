...
var ruleNames =  [ "chunk", "block", "stat", "attnamelist", "attrib", "retstat", 
...
StatContext.prototype.attnamelist = function() {
...
function AttnamelistContext(parser, parent, invokingState) {
	if(parent===undefined) {
	    parent = null;
	}
	if(invokingState===undefined || invokingState===null) {
...
AttnamelistContext.prototype = Object.create(antlr4.ParserRuleContext.prototype);
AttnamelistContext.prototype.constructor = AttnamelistContext;

AttnamelistContext.prototype.NAME = function(i) {
	if(i===undefined) {
		i = null;
	}
    if(i===null) {
...
AttnamelistContext.prototype.attrib = function(i) {
    if(i===undefined) {
        i = null;
    }
    if(i===null) {
...
AttnamelistContext.prototype.enterRule = function(listener) {
    if(listener instanceof LuaListener ) {
        listener.enterAttnamelist(this);
	}
};

AttnamelistContext.prototype.exitRule = function(listener) {
    if(listener instanceof LuaListener ) {
...
LuaParser.prototype.attnamelist = function() {

    var localctx = new AttnamelistContext(this, this._ctx, this.state);
...
AttribContext.prototype.NAME = function() {
    return this.getToken(LuaParser.NAME, 0);
};
...
LuaParser.prototype.attrib = function() {
